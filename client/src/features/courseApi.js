...
export const courseApi = createApi({
  ...
  endpoints: (builder) => ({
    ...
    // 🟢 1. ADDED: removeCourse Mutation Endpoint
    removeCourse: builder.mutation({
      query: (courseId) => ({
        url: `/${courseId}`, // Backend par jo route banaya tha: DELETE /:courseId
        method: "DELETE",
      }),
      // 🔥 Magic: Iske chaltay hi dashboard par se purana deleted course automatically gayab ho jayega!
      invalidatesTags: ["Refetch_Creator_Course"],
    }),
...
export const {
  ...
  useGetPublishedCourseQuery,
  useGetSearchCourseQuery,
  useRemoveCourseMutation, // 🟢 2. ADDED: Hook export kar diya component mein use karne ke liye
} = courseApi;